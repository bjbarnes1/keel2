...
export default function NewIncomePage() {
  return (
    <AppShell title="Add income" currentPath="/settings" backHref="/incomes">
      <form action={createIncomeAction} className="space-y-4">
        ...
        <SurfaceCard className="flex items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-xs text-muted-foreground">Used as the default for new commitments and goals.</p>
          </div>
          <input name="isPrimary" type="checkbox" className="h-5 w-5 accent-primary" />
        </SurfaceCard>
