        ...
        <SurfaceCard className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              Commitments and goals can be allocated to a specific income so per-pay amounts match the right cadence.
              Edits apply from a date you choose—past periods stay as they were.
            </p>
          </div>
          <Link
            href="/incomes/new"
            className="rounded-xl border border-border bg-card px-3 py-2 text-sm font-medium text-primary shrink-0"
          >
            + Add
          </Link>
        </SurfaceCard>
