...
export function CommitmentSkipSheet({
  ...
  const previewCopy =
    strategy === "MAKE_UP_NEXT"
      ? "Next dated bill absorbs this payment. End-of-window available money shifts by the amount below."
      : strategy === "SPREAD"
        ? `Split across the next ${spreadOverN} bill dates (when they exist). Delta reflects combined timing.`
        : goalId
          ? "This bill row drops out of the schedule; the amount is redirected in bookkeeping to your goal."
